...
class AdminUserCreatedScreen extends StatelessWidget {
  final String name;
  final String email;
  final String password;
  final String role;

  const AdminUserCreatedScreen({
    super.key,
    required this.name,
    required this.email,
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  "The access credentials for $name ($role) have been logged.\n\nThe user can now log into the application.",
  ...
  Widget build(BuildContext context) {
    ...
    String capitalizedRole = role.isNotEmpty ? "${role[0].toUpperCase()}${role.substring(1)}" : "";
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              const SizedBox(height: 20),
              Text(
                "$capitalizedRole Account Created",
                style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: textColor),
              ),
              const SizedBox(height: 10),
              Text(
                "Please share these credentials with the new user ($name).",
                textAlign: TextAlign.center,
                style: TextStyle(color: subtextColor),
              ),
              const SizedBox(height: 30),
              buildBox(context, "USERNAME / EMAIL", email),
