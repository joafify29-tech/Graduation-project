  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<DocumentSnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        String age = currentData['age']?.toString() ?? "";
        String gender = currentData['gender'] ?? "";
        String type = currentData['addiction'] ?? "";
        String status = currentData['status'] ?? "ACTIVE";
        String notes = currentData['notes'] ?? "";
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (_) => UploadReportScreen(
                              patientName: name,
                              patientId: currentData['patientId'] ?? docId,
                              addiction: type,
                              docId: docId,
                            ),
                          ),
